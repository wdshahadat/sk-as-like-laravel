...
<head>
    ...
    <link rel="stylesheet" href="<?php _(asset('assets/css/style.css')) ?>">
</head>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                        aria-haspopup="true" aria-expanded="false" v-pre> <?php _(user()->name) ?><span class="caret"></span>
                    </a>

                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="<?php _(route('logOut')) ?>">
                            Logout
                        </a>

                        <a class="dropdown-item" href="<?php _(route('change/password')) ?>">Change password</a>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <!-- Brand Logo -->
            <a href="<?php _(route('/')) ?>" class="brand-link">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php _(route('/dashboard')) ?>" class="nav-link active">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php _(route('/register')) ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php _(route('/user/list')) ?>" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>List</p>
                                    </a>
                                </li>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2021 <a href="https://shahadat.dev">Shahadat Khan</a>.</strong>
            All rights reserved.
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="<?php _(asset('assets/js/jquery-ui.min.js')) ?>"></script>
    ...
    <script src="<?php _(asset('assets/js/axios.js')) ?>"></script>
